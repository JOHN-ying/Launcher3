...
import com.android.launcher3.graphics.FolderPreview;
...
//            window.clearFlags(android.view.WindowManager.
...
//            window.setNavigationBarColor(alphaColor);
    ...
    public static class LauncherSettingsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            //add by SIM cuixiangwen 2019/01/04 start
            Preference folderPreview = findPreference(Utilities.FOLDER_PREVIEW);
            FolderPreview.handlePreferenceUi((ListPreference) folderPreview);
            //add by SIM cuixiangwen 2019/01/04 start
        }

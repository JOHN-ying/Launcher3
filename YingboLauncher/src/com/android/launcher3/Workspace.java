...
public class Workspace extends PagedView
    ...
    public void bindAndInitFirstWorkspaceScreen(View qsb) {
        //Log.d("wentao","bindAndInitFirstWorkspaceScreen "); 
        if (!Utilities.isAllowSearchWidgetPrefEnabled(getContext())) {
            return;
        }
        // Add the first page
    ...
    public void stripEmptyScreens() {
        ...
        for (int i = 0; i < total; i++) {
            ...
            if ((!Utilities.isAllowSearchWidgetPrefEnabled(getContext())|| id > FIRST_SCREEN_ID)
...
//    screenScrolle
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (v != null) {
                ...
                PageViewAnimation.getInstance().pageViewAnime(scrollProgress, i, getChildCount(), getResources().getDisplayMetrics().density, v);
            }
        }
    ...
    private void updateAccessibilityFlags(CellLayout page, int pageNo) {
        if (mState == State.OVERVIEW) {
            ...
            if (!Utilities.isAllowSearchWidgetPrefEnabled(getContext()) || pageNo > 0) {

...
public final class Utilities {
    ...
    //add by cuixiangwen 2019/1/3 start
    public static final String WALLPAPER_SCROLLS_WITH_MAIN_SCREEN = "wallpaper_scrolls_with_main_screen";
    public static final String NOTIFICATION_BAR_DISPLAY= "notification_bar_display";
    public static final String NOTIFICATION_BAR_TRANSPARENCY= "notification_bar_transparency";
    public static final String FOLDER_PREVIEW= "folder_preview";
    //add by SIM cuixiangwen 2019/01/05 end


    public static final String ALLOW_SEARCH_WIDGET_KEY = "pref_allow_searchwidght";
    ...
    //add by SIM cuixiangwen 2019/01/05 start
    public static boolean isWallpaperScrollsEnabled(Context context) {
        return getPrefs(context).getBoolean(WALLPAPER_SCROLLS_WITH_MAIN_SCREEN, true);
    }
    	
    public static boolean isNotificationBarDisplayEnabled(Context context) {
        return getPrefs(context).getBoolean(NOTIFICATION_BAR_DISPLAY, true);
    }
    	
    public static boolean isNotificationBarTransparencyEnabled(Context context) {
        return getPrefs(context).getBoolean(NOTIFICATION_BAR_TRANSPARENCY, true);
    }
    public static String folderPreviewValues(Context context){
    	return getPrefs(context).getString(FOLDER_PREVIEW, "0");
    }
    //add by SIM cuixiangwen 2019/01/05 end
	
    public static boolean isAllowSearchWidgetPrefEnabled(Context context) {
        boolean enable = getPrefs(context).getBoolean(ALLOW_SEARCH_WIDGET_KEY,
                true);
        //Log.d("wentao","isAllowSearchWidgetPrefEnabled enable:"+enable);        
        return enable;
    }

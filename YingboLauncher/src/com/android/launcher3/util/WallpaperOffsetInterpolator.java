...
public class WallpaperOffsetInterpolator implements Choreographer.FrameCallback {
    ...
    //add by SIM cuixiangwen 2019/01/04 for wallpaper_scrolls start
    if(System.getProperty("wallpaper_scrolls_with_main_screen") == "1"){
        updateOffset(false);
        }
    //add by SIM cuixiangwen 2019/01/04 for wallpaper_scrolls end
    }
